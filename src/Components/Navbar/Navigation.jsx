        ...
        <div>
            <header class='shadow-md font-sans tracking-wide relative z-50' >
                ...
                <div class='flex flex-wrap items-center justify-between gap-4 px-10 py-4 bg-white min-h-[70px]'>
                    <a href="javascript:void(0)"><h1>TANGEDCO</h1>
                    </a>
                    ...
                    <div id="collapseMenu"
                        ...
                        <ul
                            ...
                            <li to="/" class='max-lg:border-b max-lg:py-3 px-3'>
                                <Link id = "back" to="/" href='javascript:void(0)'
                                    class='hover:text-[#007bff] text-[#007bff] block font-bold text-[15px]'>Home
                                </Link>
                            </li>
                            ...
                            <li class='max-lg:border-b max-lg:py-3 px-3'><a href='javascript:void(0)'
                                class='hover:text-[#007bff] text-[#333] block font-bold text-[15px]'>User</a>
                            </li>
                        </ul>
                    </div>
